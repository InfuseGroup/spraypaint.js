...
export declare const belongsTo: <T extends SpraypaintBase>(options?: AssociationFactoryArgs<T> | undefined) => BelongsTo<T>;
export declare const hasMany: <T extends SpraypaintBase>(options?: AssociationFactoryArgs<T> | undefined) => HasMany<T>;
