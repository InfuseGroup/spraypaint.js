...
declare type DecoratorArgs<T extends SpraypaintBase> = AssociationFactoryOpts<T> | string | typeof SpraypaintBase;
declare const HasManyDecoratorFactory: {
    (optsOrType?: DecoratorArgs<SpraypaintBase> | undefined): DecoratorFn;
