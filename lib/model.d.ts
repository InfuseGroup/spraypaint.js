...
export declare type ModelRecord<T extends SpraypaintBase> = ModelAttrs<keyof (OmitCompat<T, keyof SpraypaintBase>), T>;
export declare type ModelAttributeChangeSet<T extends SpraypaintBase> = ModelAttrChanges<OmitCompat<T, keyof SpraypaintBase>>;
...
export declare const applyModelConfig: <T extends typeof SpraypaintBase>(ModelClass: T, config: ModelConfigurationOptions) => void;
export declare class SpraypaintBase {
    ...
    setMeta(metaObj: object | undefined, markDirty?: boolean): void;
    get meta(): object;
    ...
    static first<I extends typeof SpraypaintBase>(this: I): Promise<RecordProxy<I["prototype"]> | NullProxy<I["prototype"]>>;
...
export declare type PersistedSpraypaintRecord<Record extends SpraypaintBase> = Record & {
    id: string;
};
